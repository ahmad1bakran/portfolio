...
export const portfolioData = {
  en: {
    ...
    about: {
      title: "About Me",
      description: "Passionate about clean code, performance optimization, and transforming complex Figma designs into seamless user experiences. I blend deep algorithmic problem-solving with pixel-perfect UI/UX implementations.",
      education: {
        title: "Education",
    ...
    skills: {
      ...
      categories: {
        frontend: {
          ...
          items: ["HTML5", "CSS3", "JavaScript (ES6+)", "TypeScript", "React.js", "Next.js", "React Native", "Tailwind CSS", "Bootstrap", "SASS"]
        },
        design: {
          title: "Design & Tools",
      ...
      items: [
        {
          ...
          description: "Solved 2000+ programming problems on Codeforces, AtCoder, CSES, and USACO. Participated in ICPC for four consecutive seasons. Qualified for Africa & Arab ICPC Regional Finals, Egypt (2023)."
        },
        {
          title: "Awards",
          description: "2nd Place, Private Universities Programming Contest (Two consecutive years)."
        }
      ],
      certifications: {
  ...
  ar: {
    ...
    hero: {
      ...
      description: "مطور واجهات أمامية وتطبيقات موبايل متخصص في React.js و Next.js و React Native، مع خبرة قوية في بناء تطبيقات قابلة للتوسع وسهلة الاستخدام. خريج هندسة معلوماتية من الجامعة العربية الخاصة. خلفية قوية في حل المشكلات والبرمجة التنافسية، بما في ذلك المشاركة في نهائيات ICPC الإقليمية لأفريقيا والعرب.",
      location: "سوريا، حماة",
      phone: "+963 938 70119",
      email: "ahmadbakran02@gmail.com",
      linkedin: "linkedin.com/in/ahmad-bakran-80735b226",
    ...
    about: {
      title: "نبذة عني",
      description: "شغوف بالكود النظيف وتحسين الأداء وتحويل تصميمات Figma المعقدة إلى تجارب مستخدم سلسة. أدمج حل المشكلات الخوارزمية العميقة مع تطبيقات UI/UX مثالية.",
      education: {
        title: "التعليم",
      ...
      items: [
        {
          ...
          description: "حل أكثر من 2000 مشكلة برمجية على Codeforces و AtCoder و CSES و USACO. شارك في ICPC لأربع مواسم متتالية. تأهل لنهائيات ICPC الإقليمية لأفريقيا والعرب، مصر (2023)."
        },
        {
          title: "الجوائز",
          description: "المركز الثاني، مسابقة البرمجة للجامعات الخاصة (سنتان متتاليتان)."
        }
      ],
      certifications: {
        title: "الشهادات",
    ...
    projects: {
      ...
      items: [
        ...
        { 
          title: "صفحة هبوط لتطبيق لشراء البطاقات والارقام والدفع الالكتروني ولوحة تحكم", 
    ...
    contact: {
      title: "تواصل معي",
      subtitle: "أنا دائماً منفتح لمناقشة مشاريع جديدة أو أفكار إبداعية أو فرص لكوني جزءاً من رؤيتك.",
      email: "ahmadbakran02@gmail.com",
      phone: "+963 938 70119",
      location: "سوريا، حماة"
    }
